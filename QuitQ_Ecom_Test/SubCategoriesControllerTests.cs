...
using QuitQ_Ecom.Services; // Changed to use the new Services namespace
using System;
...
namespace QuitQ_Ecom_Test
{
    ...
    public class SubCategoriesControllerTests
    {
        ...
        private Mock<ISubCategoryService> _subCategoryServiceMock; // Mock the new service
        ...
        public void Setup()
        {
            ...
            _subCategoriesController = new SubCategoriesController(_subCategoryServiceMock.Object, _loggerMock.Object);
        }
        ...
        public async Task AddSubCategory_ReturnsOk()
        {
            ...
            _subCategoryServiceMock.Setup(service => service.AddSubCategory(subCategoryToAdd)).ReturnsAsync(subCategoryToAdd);
        ...
        public async Task GetAllSubCategories_ReturnsOk()
        {
            ...
            _subCategoryServiceMock.Setup(service => service.GetAllSubCategories()).ReturnsAsync(mockSubCategories);
        ...
        public async Task GetSubCategoryById_ExistingId_ReturnsOk()
        {
            ...
            _subCategoryServiceMock.Setup(service => service.GetSubCategoryById(subCategoryId)).ReturnsAsync(mockSubCategory);
        ...
        public async Task GetSubCategoryById_NonExistingId_ReturnsNotFound()
        {
            // Arrange
            int subCategoryId = 1;
            _subCategoryServiceMock.Setup(service => service.GetSubCategoryById(subCategoryId)).ReturnsAsync((SubCategoryDTO)null);
        ...
        public async Task UpdateSubCategory_ReturnsOk()
        {
            ...
            _subCategoryServiceMock.Setup(service => service.UpdateSubCategory(subCategoryToUpdate)).ReturnsAsync(subCategoryToUpdate);
        ...
        public async Task DeleteSubCategory_ExistingId_ReturnsOk()
        {
            // Arrange
            int subCategoryId = 1;
            _subCategoryServiceMock.Setup(service => service.DeleteSubCategory(subCategoryId)).ReturnsAsync(true);
        ...
        public async Task DeleteSubCategory_NonExistingId_ReturnsNotFound()
        {
            // Arrange
            int subCategoryId = 1;
            _subCategoryServiceMock.Setup(service => service.DeleteSubCategory(subCategoryId)).ReturnsAsync(false);
