...
namespace QuitQ_Ecom_Test
{
    ...
    public class CityControllerTest
    {
        ...
        public void Setup()
        {
            ...
            _cityController = new CityController(_cityServiceMock.Object, _loggerMock.Object);
        }
        ...
        public async Task GetAllCities_Valid_ReturnsOk()
        {
            ...
            _cityServiceMock.Setup(service => service.GetAllCities()).ReturnsAsync(cities);
        ...
        public async Task GetCityById_ExistingId_ReturnsOk()
        {
            ...
            _cityServiceMock.Setup(service => service.GetCityById(cityId)).ReturnsAsync(city);
        ...
        public async Task GetCityById_NonExistingId_ReturnsNotFound()
        {
            // Arrange
            int cityId = 1;
            _cityServiceMock.Setup(service => service.GetCityById(cityId)).ThrowsAsync(new CityNotFoundException($"City with ID {cityId} not found."));
            ...
            Assert.AreEqual("City not found", notFoundResult.Value);
        }
        ...
        public async Task AddCity_ValidData_ReturnsCreatedAtAction()
        {
            ...
            _cityServiceMock.Setup(service => service.AddCity(cityDTO)).ReturnsAsync(cityDTO);
        ...
        public async Task UpdateCityState_ValidData_ReturnsOk()
        {
            ...
            _cityServiceMock.Setup(service => service.UpdateCityState(cityId, stateId)).ReturnsAsync(updatedCity);
        ...
        [Test]
        public async Task UpdateCityState_InvalidCityId_ReturnsNotFound()
        {
            // Arrange
            int cityId = 1;
            int stateId = 2;
            _cityServiceMock.Setup(service => service.UpdateCityState(cityId, stateId)).ThrowsAsync(new CityNotFoundException($"City with ID {cityId} not found."));
        ...
        [Test]
        public async Task UpdateCityState_InvalidStateId_ReturnsNotFound()
        {
            // Arrange
            int cityId = 1;
            int stateId = 999;
            _cityServiceMock.Setup(service => service.UpdateCityState(cityId, stateId)).ThrowsAsync(new StateNotFoundException($"State with ID {stateId} not found."));
        ...
        public async Task DeleteCity_ExistingId_ReturnsOk()
        {
            // Arrange
            int cityId = 1;
            _cityServiceMock.Setup(service => service.DeleteCity(cityId)).ReturnsAsync(true);
        ...
        public async Task DeleteCity_NonExistingId_ReturnsNotFound()
        {
            // Arrange
            int cityId = 1;
            _cityServiceMock.Setup(service => service.DeleteCity(cityId)).ThrowsAsync(new CityNotFoundException($"City with ID {cityId} not found."));
