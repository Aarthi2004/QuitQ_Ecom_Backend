    ...
    public class CategoryRepositoryImpl : ICategory
    {
        ...
        public async Task<CategoryDTO> AddCategory(CategoryDTO categoryDTO)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new AddCategoryException("Error occurred while adding category.", ex);
            }
        }
        ...
        public async Task<bool> DeleteCategory(int categoryId)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new DeleteCategoryException($"Error occurred while deleting category with ID {categoryId}.", ex);
            }
        }
        ...
        public async Task<List<CategoryDTO>> GetAllCategories()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new GetAllCategoriesException("Error occurred while retrieving all categories.", ex);
            }
        }
        ...
        public async Task<CategoryDTO> GetCategoryById(int categoryId)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new GetCategoryByIdException($"Error occurred while retrieving category with ID {categoryId}.", ex);
            }
        }
        ...
        public async Task<List<ProductDTO>> GetProductsByCategory(int categoryId)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new GetProductsByCategoryException($"Error occurred while retrieving products for category with ID {categoryId}.", ex);
            }
        }
        ...
        public async Task<List<SubCategoryDTO>> GetSubCategoriesByCategoryId(int categoryId)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new GetSubcategoriesByCategoryException($"Error occurred while retrieving subcategories for category with ID {categoryId}.", ex);
            }
        }
        ...
        public async Task<CategoryDTO> UpdateCategory(CategoryDTO categoryDTO)
        {
            try
            {
                ...
                if (category == null)
                    throw new CategoryNotFoundException($"Category with ID {categoryDTO.CategoryId} not found.");
            ...
            catch (Exception ex)
            {
                ...
                throw new UpdateCategoryException("Error occurred while updating category.", ex);
            }
        }
    }
}