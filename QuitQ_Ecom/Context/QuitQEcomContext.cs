...
public partial class QuitQEcomContext : DbContext
{
    ...
    public virtual DbSet<QuitQ_Ecom.Models.Image> Images { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<QuitQ_Ecom.Models.Image>(entity =>
        {
        ...
        modelBuilder.Entity<UserType>().HasData(
            new UserType { UserTypeId = 1, UserType1 = "Admin" },
            new UserType { UserTypeId = 2, UserType1 = "Seller" },
            new UserType { UserTypeId = 3, UserType1 = "Customer" }
        );

        modelBuilder.Entity<UserStatus>().HasData(
            new UserStatus { UserStatusId = 1, UserStatus1 = "Active" },
            new UserStatus { UserStatusId = 2, UserStatus1 = "Inactive" },
            new UserStatus { UserStatusId = 3, UserStatus1 = "Banned" }
        );
